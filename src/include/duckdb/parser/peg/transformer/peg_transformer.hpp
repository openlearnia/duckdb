...
public:
	...
	static unique_ptr<TransformResultValue> FinalizeRefreshStatementTrampoline(PEGTransformer &transformer,
	                                                                           GeneratedTransformProcess &process);
	static void InitializeRefreshIfStaleTrampoline(PEGTransformer &transformer, GeneratedTransformProcess &process);
	static unique_ptr<TransformResultValue> FinalizeRefreshIfStaleTrampoline(PEGTransformer &transformer,
	                                                                         GeneratedTransformProcess &process);
	...
	static unique_ptr<TransformResultValue> FinalizeTableMacroDefinitionTrampoline(PEGTransformer &transformer,
	                                                                               GeneratedTransformProcess &process);
	static void InitializeCreateProcedureStmtTrampoline(PEGTransformer &transformer,
	                                                    GeneratedTransformProcess &process);
	static unique_ptr<TransformResultValue> FinalizeCreateProcedureStmtTrampoline(PEGTransformer &transformer,
	                                                                              GeneratedTransformProcess &process);
	static void InitializeProcedureParametersTrampoline(PEGTransformer &transformer,
	                                                    GeneratedTransformProcess &process);
	...
	static void InitializeCreateMaterializedViewStmtTrampoline(PEGTransformer &transformer,
	                                                           GeneratedTransformProcess &process);
	static unique_ptr<TransformResultValue>
	FinalizeCreateMaterializedViewStmtTrampoline(PEGTransformer &transformer, GeneratedTransformProcess &process);
	...
	static unique_ptr<TransformResultValue> FinalizeDropProcedureTrampoline(PEGTransformer &transformer,
	                                                                        GeneratedTransformProcess &process);
