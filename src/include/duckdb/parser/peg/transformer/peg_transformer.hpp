...
public:
	...
	static void InitializeRefreshStatementTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                 TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRefreshStatementTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	static void InitializeRefreshIfStaleTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                               TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeRefreshIfStaleTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	...
	static unique_ptr<TransformResultValue> FinalizeTableMacroDefinitionTrampoline(PEGTransformer &transformer,
	                                                                               TransformStack &stack,
	                                                                               TransformStackFrame &frame);
	static void InitializeCreateProcedureStmtTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                    TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizeCreateProcedureStmtTrampoline(PEGTransformer &transformer,
	                                                                              TransformStack &stack,
	                                                                              TransformStackFrame &frame);
	static void InitializeProcedureParametersTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                    TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizeProcedureParametersTrampoline(PEGTransformer &transformer,
	                                                                              TransformStack &stack,
	                                                                              TransformStackFrame &frame);
	static void InitializeProcedureParameterTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                   TransformStackFrame &frame);
	...
	static unique_ptr<TransformResultValue> FinalizeCreateStatementVariationTrampoline(PEGTransformer &transformer,
	                                                                                   TransformStack &stack,
	                                                                                   TransformStackFrame &frame);
	static void InitializeCreateMaterializedViewStmtTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                                           TransformStackFrame &frame);
	static unique_ptr<TransformResultValue> FinalizeCreateMaterializedViewStmtTrampoline(PEGTransformer &transformer,
	                                                                                     TransformStack &stack,
	                                                                                     TransformStackFrame &frame);
	...
	static void InitializeDropProcedureTrampoline(PEGTransformer &transformer, TransformStack &stack,
	                                              TransformStackFrame &frame);
	static unique_ptr<TransformResultValue>
	FinalizeDropProcedureTrampoline(PEGTransformer &transformer, TransformStack &stack, TransformStackFrame &frame);
	...
	static unique_ptr<TransformResultValue> TransformExpressionAliasInternal(PEGTransformer &transformer,
	                                                                         ParseResult &parse_result);
	static unique_ptr<TransformResultValue> TransformRefreshStatementInternal(PEGTransformer &transformer,
	                                                                          ParseResult &parse_result);
	static unique_ptr<SQLStatement> TransformRefreshStatement(PEGTransformer &transformer,
	                                                          const optional<bool> &refresh_if_stale,
	                                                          const QualifiedName &qualified_name);
	static unique_ptr<TransformResultValue> TransformRefreshIfStaleInternal(PEGTransformer &transformer,
	                                                                        ParseResult &parse_result);
	...
	static unique_ptr<TransformResultValue> TransformCreateProcedureStmtInternal(PEGTransformer &transformer,
	                                                                             ParseResult &parse_result);
	static unique_ptr<CreateStatement>
	...
	static unique_ptr<TransformResultValue> TransformProcedureParametersInternal(PEGTransformer &transformer,
	                                                                             ParseResult &parse_result);
	...
	static unique_ptr<TransformResultValue> TransformProcedureParameterInternal(PEGTransformer &transformer,
	                                                                            ParseResult &parse_result);
	...
	static unique_ptr<TransformResultValue> TransformCreateStatementVariationInternal(PEGTransformer &transformer,
	                                                                                  ParseResult &parse_result);
	static unique_ptr<TransformResultValue> TransformCreateMaterializedViewStmtInternal(PEGTransformer &transformer,
	                                                                                    ParseResult &parse_result);
	static unique_ptr<CreateStatement> TransformCreateMaterializedViewStmt(PEGTransformer &transformer,
	                                                                       const optional<bool> &if_not_exists,
	                                                                       const QualifiedName &qualified_name,
	...
	static unique_ptr<TransformResultValue> TransformDropProcedureInternal(PEGTransformer &transformer,
	                                                                       ParseResult &parse_result);
