...
public:
	...
	//! Invoke this override under the default parser policy. Extensions should use this only
	//! for narrowly scoped grammar additions that decline statements they do not own.
