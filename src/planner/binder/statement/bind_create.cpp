...
BoundStatement Binder::Bind(CreateStatement &stmt) {
	...
	case CatalogType::TABLE_ENTRY: {
		...
		if (create_info.materialized_view_refresh) {
			...
			create_info.materialized_view_refresh_durations = table.GetMaterializedViewRefreshDurations();
			create_info.materialized_view_refresh_rows_written = table.GetMaterializedViewRefreshRowsWritten();
			create_info.materialized_view_refresh_rows_added = table.GetMaterializedViewRefreshRowsAdded();
			create_info.materialized_view_refresh_rows_removed = table.GetMaterializedViewRefreshRowsRemoved();
			create_info.materialized_view_refresh_rows_changed = table.GetMaterializedViewRefreshRowsChanged();
			...
			if (!create_info.materialized_view_skip_refresh) {
				...
				create_info.materialized_view_refresh_durations.push_back(-1);
				create_info.materialized_view_refresh_rows_written.push_back(-1);
				create_info.materialized_view_refresh_rows_added.push_back(-1);
				create_info.materialized_view_refresh_rows_removed.push_back(-1);
				create_info.materialized_view_refresh_rows_changed.push_back(-1);
			}
		}
