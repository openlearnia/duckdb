...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRefreshStatementInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	optional<bool> refresh_if_stale {};
	auto &refresh_if_stale_opt = list_pr.GetChild(3).Cast<OptionalParseResult>();
	if (refresh_if_stale_opt.HasResult()) {
		auto refresh_if_stale_value = transformer.Transform<bool>(refresh_if_stale_opt.GetResult());
		refresh_if_stale = refresh_if_stale_value;
	}
	auto qualified_name = transformer.Transform<QualifiedName>(list_pr.GetChild(4));
	auto result = TransformRefreshStatement(transformer, refresh_if_stale, qualified_name);
	return make_uniq<TypedTransformResult<unique_ptr<SQLStatement>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRefreshIfStaleInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto result = TransformRefreshIfStale(transformer);
	return make_uniq<TypedTransformResult<bool>>(result);
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformProcedureParametersInternal(
	...
	auto result = TransformProcedureParameters(transformer, std::move(procedure_parameter));
	return make_uniq<TypedTransformResult<vector<MacroParameter>>>(std::move(result));
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformCreateMaterializedViewStmtInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	optional<bool> if_not_exists {};
	auto &if_not_exists_opt = list_pr.GetChild(2).Cast<OptionalParseResult>();
	...
	auto result = TransformCreateMaterializedViewStmt(transformer, if_not_exists, qualified_name, std::move(statement));
	return make_uniq<TypedTransformResult<unique_ptr<CreateStatement>>>(std::move(result));
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformTypeFuncKeywordInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	string result;
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformNestedSchemaTableColumnNameInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto catalog_qualification = transformer.Transform<Identifier>(list_pr.GetChild(0));
	auto reserved_schema_qualification = transformer.Transform<Identifier>(list_pr.GetChild(1));
	...
	for (auto &reserved_schema_qualification_2_item : reserved_schema_qualification_2_repeat.GetChildren()) {
		auto reserved_schema_qualification_2_value = transformer.Transform<Identifier>(reserved_schema_qualification_2_item.get());
	...
	auto result = TransformNestedSchemaTableColumnName(transformer, catalog_qualification, reserved_schema_qualification, reserved_schema_qualification_1, reserved_schema_qualification_2, reserved_column_name);
	return make_uniq<TypedTransformResult<unique_ptr<ColumnRefExpression>>>(std::move(result));
}
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformInstallStatementInternal(
	...
	auto result = TransformInstallStatement(transformer, has_result, install_and_load, identifier_or_string_literal, from_source, version_number);
	return make_uniq<TypedTransformResult<unique_ptr<SQLStatement>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformInstallAndLoadInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformExtensionRepositoryStatementInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	auto &choice_pr = list_pr.Child<ChoiceParseResult>(0);
	auto result = transformer.Transform<unique_ptr<SQLStatement>>(choice_pr.GetResult());
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformCreateExtensionRepositoryStmtInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	optional<bool> or_replace {};
	auto &or_replace_opt = list_pr.GetChild(1).Cast<OptionalParseResult>();
	...
	auto result = TransformCreateExtensionRepositoryStmt(transformer, or_replace, if_not_exists, col_id_or_string, repository_prefix, repository_public_key);
	return make_uniq<TypedTransformResult<unique_ptr<SQLStatement>>>(std::move(result));
}

unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRepositoryPrefixInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	bool has_result {};
	auto &has_result_opt = list_pr.GetChild(0).Cast<OptionalParseResult>();
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformRepositoryPublicKeyInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	bool has_result {};
	auto &has_result_opt = list_pr.GetChild(0).Cast<OptionalParseResult>();
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformDropExtensionRepositoryStmtInternal(
    PEGTransformer &transformer, ParseResult &parse_result) {
	auto &list_pr = parse_result.Cast<ListParseResult>();
	optional<bool> if_exists {};
...
unique_ptr<TransformResultValue> PEGTransformerFactory::TransformTableSubqueryInternal(
	...
	auto result = TransformTableSubquery(transformer, table_alias_colon, lateral, std::move(subquery_reference), table_alias);
	return make_uniq<TypedTransformResult<unique_ptr<TableRef>>>(std::move(result));
}
...
void PEGTransformerFactory::RegisterGenerated() {
	static const TransformRule builtin_transform_rules[] = {
		...
		{"RefreshStatement", &PEGTransformerFactory::TransformRefreshStatementInternal},
		{"RefreshIfStale", &PEGTransformerFactory::TransformRefreshIfStaleInternal},
		...
		{"CreateMaterializedViewStmt", &PEGTransformerFactory::TransformCreateMaterializedViewStmtInternal},
